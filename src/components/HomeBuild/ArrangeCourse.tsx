...
const ArrangeCourse = () => {
  return (
    <Container>
      <Card> what you get to Learn! </Card>
      <Wrapper>
        <CoursCard
          to="/course"
          bcl="#FEF3E9"
        ...
        <CoursCard
          ...
          img={p}
          title="Soft Skill"
          para="Softskills are collections of productive personality that characterizes ones relationship in a social environment. you will learn softskills such as critical thinking, problem solving , public speaking, teamwork, leadership, professional attitude, work ethics and you will learn these skill by  implementation"
        />
      </Wrapper>
    </Container>
  );
