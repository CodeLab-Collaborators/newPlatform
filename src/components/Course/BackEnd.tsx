    ...
    <Container>
      <Wrapper>
        <LearnComp
          ...
          path="Technical Courses is an exciting career track. Like many would suggests, this includes backend engineering, Cretical thinking, Data Structure, Algorithm and many more... this deals with the part of a website or a software application that the users do not see or interact with directly. As a backend engineer, you are responsible for building the structure of a software application. In this program, you will learn how to program servers, client-side interfaces and design databases using the various programming languages."
        />

        <Desc>
          <Title>Technical Track Courses</Title>
          <Sub>
